 ...
 * 
 * @param characterName - The name of the character to use
 * @returns The session ID for the initialized agent
 */
export async function initializeAgent(characterName: string = 'eric'): Promise<{ sessionId: string }> {
  try {
    // Load character
