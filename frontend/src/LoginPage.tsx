...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 md:p-12 bg-red-400">
      <div className="flex flex-col items-center bg-amber-50 p-8 rounded-lg shadow-xl border border-gray-800 w-full max-w-md">
        <h1 className="text-red-400 font-bold text-3xl mb-8">Welcome to HomeSpace</h1>
      ...
      <button
        ...
        className="px-6 py-3 mt-4 bg-amber-50 text-black rounded-lg hover:bg-red-400 transition-colors text-center font-medium"
      >
        Go to homepage
      </button>
    </main>
